...
from azure.ai.agents.models import DeepResearchTool,MessageDeltaChunk
import gradio as gr
    ...
    with project_client:
        ...
        with project_client.agents as agents_client:
            ...
            agent = agents_client.create_agent(
                ...
                instructions="You are a helpful Agent that assists in researching scientific topics and not only.",
...
with gr.Blocks(theme=brand_theme, css="footer {visibility: hidden;}", fill_height=True) as demo:
    ...
    gr.HTML("<h1 style=\"text-align: center;\">Azure AI Agent Service</h1><h2 style=\"text-align: center;\">With Deep research tool</h2>")

    chatbot = gr.Chatbot(
        type="messages",
        examples=[
            {"text": "Give me the latest research into quantum computing over the last year. In am interested in Hardware advancements in particular on superconducting qubits."},
            ...
            {"text": "Tell me why the salt on ices streets is useful. give me a scientific explanation with chimical formulas."},
        ],
        show_label=False,
        scale=1,
    )
