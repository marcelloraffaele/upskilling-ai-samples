...
class WeatherTools:
    ...
    @tool(approval_mode="never_require", description="Get the geo coordinates and other location info like: latitude, longitude, elevation, timezone, population, country of a location. Example: get_geocode(location='Rome')")
    ...
    @tool(approval_mode="never_require", description="Get the meteo forecast for a given latitude and longitude. Example: get_forecast(  latitude=41.8919, longitude=12.5113)")
